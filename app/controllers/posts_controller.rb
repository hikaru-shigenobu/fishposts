class PostsController < ApplicationController
  ...
  def search
    if params[:search].present?
      @posts = Post.where('title LIKE :word OR date LIKE :word OR time LIKE :word OR address LIKE :word OR whether LIKE :word OR temperature LIKE :word OR water_temperature LIKE :word OR tide LIKE :word', word: "%#{params[:search]}%")
